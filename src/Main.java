public class Main {
    public static void main(String[] args) {
        ...
        // в условии задачи не прописано, что выводить при 5 градусах, принял на свое усмотрение в связи с замечаниями наставника.
        System.out.println();
        ...
        // в условии задачи не прописано, что выводить при скорости 60 км/ч, принял на свое усмотрение в связи с замечаниями наставника.
                System.out.println();
